...
<div class="py-2 px-6 bg-[#111827] flex items-center shadow-md shadow-black/5 fixed w-full top-0 left-0 z-30">
    ...
    <ul class="ml-auto flex items-center">
        <li class="mr-1 dropdown">
            <button type="button"
                class="dropdown-toggle text-white mr-4 w-8 h-8 rounded flex items-center justify-center  hover:text-white">
            ...
            <div
                ...
                <div class="flex items-center px-4 pt-4 border-b border-b-gray-100 notification-tab">
                    <button type="button" data-tab="notification" data-tab-page="notifications"
                        class="text-white font-medium text-[13px] hover:text-white border-b-2 border-b-transparent mr-4 pb-1 active">Notifications</button>
                    <button type="button" data-tab="notification" data-tab-page="messages"
                        class="text-white font-medium text-[13px] hover:text-white border-b-2 border-b-transparent mr-4 pb-1">Messages</button>
                </div>
        ...
        <li class="dropdown ml-3">
            ...
            <ul
                ...
                <li>
                    <a href="#"
                        class="flex items-center text-[13px] py-1.5 px-4 text-grey-900 hover:text-[#f84525] hover:bg-gray-50">Profile</a>
                </li>
                <li>
                    <a href="#"
                        class="flex items-center text-[13px] py-1.5 px-4 text-grey-900 hover:text-[#f84525] hover:bg-gray-50">Settings</a>
                </li>
                <li>
                    <form method="POST" action="../system/logout.php">
                        <button type="submit" role="menuitem"
                            class="flex items-center text-[13px] py-1.5 px-4 text-grey-900 hover:text-[#f84525] hover:bg-gray-50 cursor-pointer">
                            Log Out
                        </button>
                    </form>
                </li>
